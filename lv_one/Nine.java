...
public class Nine {
    public static void main(String[] args){
        System.out.println(solution(5,3,2)); // timeout
        System.out.println(bestSolution(5,3,2)); // 약수구하기는 제곱근을 이용하자 !!!
    }
    ...
    public static int bestSolution(int number, int limit, int power){
        int answer = 0;
        for(int i = 1; i <= number; i++) {
            int cnt = div(i);
